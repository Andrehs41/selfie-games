...
//   • Sigue intentando (×3)   → peso 55 c/u → 165/300 = 55%
//   • Bonos 20% Off (×2)      → peso 45 c/u →  90/300 = 30%
...
const ROULETTE_SEGMENTS = [
  ...
  { id: 2, label: 'Sigue intentando', type: 'retry', weight: 55 },
  { id: 3, label: 'Acondicionador Viajero', type: 'win', weight: 21 },
  { id: 4, label: 'Bono 20% Off', type: 'win', weight: 45 },
  { id: 5, label: 'Sigue intentando', type: 'retry', weight: 55 },
  { id: 6, label: 'Kit Viajero', type: 'win', weight: 3 },
  { id: 7, label: 'Bono 20% Off', type: 'win', weight: 45 },
  { id: 8, label: 'Sigue intentando', type: 'retry', weight: 55 },
];
