...
//
// Distribución pedida por el cliente (suma de pesos = 300):
//   • Sigue intentando (×3)     → peso 85 c/u → 255/300 = 85%
//   • Bonos (20% Off ×2)        → peso 15 c/u →  30/300 = 10%
//   • Productos (Shampoo, Acond, Kit ×3) → peso 5 c/u → 15/300 = 5%
const ROULETTE_SEGMENTS = [
  { id: 1, label: 'Shampoo Viajero', type: 'win', weight: 5 },
  { id: 2, label: 'Sigue intentando', type: 'retry', weight: 85 },
  { id: 3, label: 'Acondicionador Viajero', type: 'win', weight: 5 },
  { id: 4, label: 'Bono 20% Off', type: 'win', weight: 15 },
  { id: 5, label: 'Sigue intentando', type: 'retry', weight: 85 },
  { id: 6, label: 'Kit Viajero', type: 'win', weight: 5 },
  { id: 7, label: 'Bono 20% Off', type: 'win', weight: 15 },
  { id: 8, label: 'Sigue intentando', type: 'retry', weight: 85 },
];
