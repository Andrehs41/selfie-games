...
//   • Bonos (20% Off ×2)        → peso 60 c/u  → 120/300 = 40%
//   • Sigue intentando (×3)     → peso 40 c/u  → 120/300 = 40%
//   • Productos (Shampoo, Acond, Kit ×3) → peso 20 c/u → 60/300 = 20%
const ROULETTE_SEGMENTS = [
  { id: 1, label: 'Shampoo Viajero', type: 'win', weight: 20 },
  { id: 2, label: 'Sigue intentando', type: 'retry', weight: 40 },
  { id: 3, label: 'Acondicionador Viajero', type: 'win', weight: 20 },
  { id: 4, label: 'Bono 20% Off', type: 'win', weight: 60 },
  { id: 5, label: 'Sigue intentando', type: 'retry', weight: 40 },
  { id: 6, label: 'Kit Viajero', type: 'win', weight: 20 },
